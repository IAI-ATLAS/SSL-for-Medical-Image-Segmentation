...
from DLIP.data.coco.coco_dataset import CocoDataset

class CocoDataModule(BasePLDataModule):
    def __init__(
        self,
        root_dir: str,
        batch_size: int,
        ...
        self.labeled_train_dataset: CocoDataset = None
        self.unlabeled_train_dataset: CocoDataset = None
        self.val_dataset: CocoDataset = None
        self.test_dataset: CocoDataset = None
        self.__init_datasets()

    def __init_datasets(self):
        self.labeled_train_dataset = CocoDataset(
        ...
        self.unlabeled_train_dataset = CocoDataset(
            root_dir=self.train_root_dir,
