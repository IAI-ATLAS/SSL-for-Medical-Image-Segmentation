...
class TranslateY(GeometricTransform):
    ...
    def apply(        
        ...
        **params
        ...
        value = int(value * img_shape[1])
        image = image.transform(image.size, PIL.Image.AFFINE, (1, 0, 0, 0, 1, value), resample=PIL.Image.BILINEAR) 
    ...
    def apply_to_mask(
        ...
        **params
        ...
        for i in range(image.shape[2]):
            ...
            mask_i = mask_i.transform(mask_i.size, PIL.Image.AFFINE, (1, 0, 0, 0, 1, value), resample=PIL.Image.NEAREST) 
