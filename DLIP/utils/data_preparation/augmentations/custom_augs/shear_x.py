...
class ShearX(GeometricTransform):
    """ShearX Transform"""
    def __init__(
        self, 
        value, 
    ...
    def apply(        
        ...
        **params
        ...
        image = image.transform(image.size, PIL.Image.AFFINE, (1, value, 0, 0, 1, 0), resample=PIL.Image.BILINEAR) 
    ...
    def apply_to_mask(
        ...
        **params
        ...
        for i in range(image.shape[2]):
            ...
            mask_i = mask_i.transform(mask_i.size, PIL.Image.AFFINE, (1, value, 0, 0, 1, 0), resample=PIL.Image.NEAREST) 
